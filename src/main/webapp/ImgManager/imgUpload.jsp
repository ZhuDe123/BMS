...
<div class="rg_layout">
    <div class="rg_left">
        ...
        <div class="img">
            <img id="viewImg2" width="250px" height="300px" alt="请上传图片">
            <img id="viewImg">
        </div>
    ...
    <div class="rg_center">
        ...
        <div class="rg_form">
            <!--定义表单 form-->
            <form action="<c:url context='${pageContext.request.contextPath}' value='/UploadImg'></c:url>" method="post" enctype="multipart/form-data">
                ...
                <table style="padding-top: 40px; border-collapse:separate; border-spacing:2px 30px;">
                    ...
                    <tr>
                        ...
                        <td class="td_right">
                            <input type='text' name='filename' id="photoName" >
                        </td>
                    </tr>

                    <tr>
                        <td class="td_left"><label>图片类型：</label></td>
                        <td class="td_right">
                    ...
                    <tr>
                        <td class="td_left"><label for="upLoad">上传图片</label></td>
                        <td class="td_right">
                    ...
                    <tr>
                        <td colspan="2" align="center">
                            <input type="submit" id="btn_sub" value="上传"><br>
                        </td>
                    </tr>
                </table>
